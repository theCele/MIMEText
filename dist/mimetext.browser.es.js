import { Base64 as e } from "js-base64";
import t from "@babel/runtime-corejs3/helpers/esm/defineProperty";
import { randomBytes as s } from "crypto";
import n from "@babel/runtime-corejs3/core-js/instance/trim";
...
class a {
    ...
    parse(e) {
        if (this.isMailboxAddrObject(e))
            return (
                (this.addr = e.addr),
                "string" == typeof e.name && (this.name = e.name),
        ...
        if (this.isMailboxAddrText(e)) {
            ...
            if (t.startsWith("<") && t.endsWith(">"))
                return (this.addr = t.slice(1, -1)), this;
            const s = t.split(" <");
            return (
                (s[0] = /^("|')/.test(s[0]) ? s[0].slice(1) : s[0]),
                (s[0] = /("|')$/.test(s[0]) ? s[0].slice(0, -1) : s[0]),
                (s[1] = s[1].slice(0, -1)),
                (this.name = s[0]),
                (this.addr = s[1]),
                this
...
class r {
        ...
        t(this, "envctx", void 0),
            t(this, "fields", [
                ...
                },
                {
                    ...
                    dump: (e) =>
                        "string" == typeof e
                            ? "=?utf-8?B?" + this.envctx.toBase64(e) + "?="
                            : "",
                },
        ...
        for (const t of this.fields) {
            ...
            if (!s && t.required)
                throw new i(
                    ...
                    'The "'.concat(t.name, '" header is required.'),
                );
            if (!s && "function" != typeof t.generator) continue;
            s || "function" != typeof t.generator || (t.value = t.generator());
            const n =
                Object.hasOwn(t, "dump") && "function" == typeof t.dump
                    ? t.dump(t.value)
                    : "string" == typeof t.value
                      ? t.value
                      : "";
            e += "".concat(t.name, ": ").concat(n).concat(this.envctx.eol);
        }
    ...
    remove(e) {
        ...
        this.fields = this.fields.filter((e) => e.name.toLowerCase() !== t);
    }
    removeMany(e) {
        const t = (e) => e.toLowerCase(),
            s = new Set(e.map(t));
        this.fields = this.fields.filter((e) => !s.has(t(e.name)));
    }
    has(e) {
        return this.fields.some((t) => lower(t.name) === lower(e));
    }
    set(e, t) {
        const s = (t) => t.name.toLowerCase() === e.toLowerCase();
        if (!!this.fields.some(s)) {
            const n = this.fields.findIndex(s),
                a = this.fields[n];
            if (a.validate && !a.validate(t))
                throw new i(
                    "MIMETEXT_INVALID_HEADER_VALUE",
                    'The value for the header "'.concat(e, '" is invalid.'),
                );
            return (this.fields[n].value = t), this.fields[n];
        }
    ...
    validateMailboxMulti(e) {
        return e instanceof a || this.isArrayOfMailboxes(e);
    }
    dumpMailboxMulti(e) {
        const t = (e) =>
            0 === e.name.length
                ? e.dump()
                : "=?utf-8?B?"
                      .concat(this.envctx.toBase64(e.name), "?= <")
                      .concat(e.addr, ">");
        return this.isArrayOfMailboxes(e)
            ? e.map(t).join(",".concat(this.envctx.eol, " "))
            : e instanceof a
              ? t(e)
              : "";
    }
    ...
    isHeaderField(e) {
        ...
        if (this.isObject(e)) {
            ...
            if (
                ...
                s.name.length > 0 &&
                !Object.keys(s).some((e) => !t.includes(e))
            )
                return !0;
        }
        return !1;
    ...
    isArrayOfMailboxes(e) {
        return this.isArray(e) && e.every((e) => e instanceof a);
    }
    isArray(e) {
...
class d {
    constructor(e, s) {
        ...
        t(this, "envctx", void 0),
            t(this, "headers", void 0),
            t(this, "data", void 0),
            (this.envctx = e),
            (this.headers = new o(this.envctx)),
            (this.data = s),
            this.setHeaders(n);
    }
    dump() {
...
class h {
    constructor(e) {
        t(this, "envctx", void 0),
            t(this, "headers", void 0),
            t(this, "boundaries", { mixed: "", alt: "", related: "" }),
            t(this, "validTypes", ["text/html", "text/plain"]),
            t(this, "validContentTransferEncodings", [
                "7bit",
                "8bit",
                "binary",
                "quoted-printable",
            ...
            t(this, "messages", []),
            (this.envctx = e),
            (this.headers = new r(this.envctx)),
            (this.messages = []),
    ...
    dumpTextContent(e, t, s) {
        ...
        return (
            (a =
                e && t && (this.hasInlineAttachments() || this.hasAttachments())
                    ? "--" +
                      s +
                      n +
                      "Content-Type: multipart/alternative; boundary=" +
    ...
    getMessageByType(e) {
        const t = (t) =>
            !t.isAttachment() &&
            !t.isInlineAttachment() &&
            (t.getHeader("Content-Type") || "").includes(e);
    ...
    addAttachment(e) {
        ...
        let a =
            (null !== (t = e.headers["Content-Type"]) && void 0 !== t
                ? t
                : e.contentType) || "none";
        if (!1 === this.envctx.validateContentType(a))
            throw new i(
                "MIMETEXT_INVALID_MESSAGE_TYPE",
                'You specified an invalid content type "'.concat(a, '".'),
            );
        const r =
            null !==
                (s =
                    null !== (n = e.headers["Content-Transfer-Encoding"]) &&
                    void 0 !== n
                        ? n
                        : e.encoding) && void 0 !== s
                ? s
        ...
        const o = e.headers["Content-ID"];
        "string" == typeof o &&
            o.length > 2 &&
            !o.startsWith("<") &&
            !o.endsWith(">") &&
            (e.headers["Content-ID"] = "<" + e.headers["Content-ID"] + ">");
        const d = e.inline ? "inline" : "attachment";
        return (
            ...
            this._addMessage({ data: e.data, headers: e.headers })
        );
    }
    addMessage(e) {
        var t, s, n, a;
        ...
        if (!this.validTypes.includes(r))
            throw new i(
                ...
                "Valid content types are "
                    .concat(this.validTypes.join(", "), ' but you specified "')
                    .concat(r, '".'),
            );
        const o =
            null !==
        ...
        const d = null !== (a = e.charset) && void 0 !== a ? a : "UTF-8";
        return (
            (e.headers = Object.assign({}, e.headers, {
                "Content-Type": "".concat(r, "; charset=").concat(d),
    ...
    _addMessage(e) {
        const t = new d(this.envctx, e.data, e.headers);
    ...
    setRecipients(e) {
        let t =
            arguments.length > 1 && void 0 !== arguments[1]
                ? arguments[1]
                : { type: "To" };
        const s = (this.isArray(e) ? e : [e]).map((e) => new a(e, t));
    ...
    generateBoundaries() {
        const e = () => {
            const e = (e) => s(e).toString("hex");
            return "000000000000" + e(8) + e(3);
        };
        this.boundaries = { mixed: e(), alt: e(), related: e() };
    }
    isArray(e) {
        return !!e && e.constructor === Array;
    }
...
const l = {
    ...
    toBase64WebSafe: function (t) {
        return e.encodeURI(t);
    },
    eol: "\r\n",
    validateContentType: (e) => e.length > 0 && e,
};
function c() {
    return new h(l);
}
export {
    h as MIMEMessage,
    d as MIMEMessageContent,
    r as MIMEMessageHeader,
    i as MIMETextError,
    a as Mailbox,
    c as createMimeMessage,
};
