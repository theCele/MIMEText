"use strict";
var e = require("js-base64"),
    t = require("@babel/runtime-corejs3/helpers/esm/defineProperty"),
    s = require("crypto"),
    n = require("@babel/runtime-corejs3/core-js/instance/trim");
...
class h {
    ...
    generateBoundaries() {
        const e = () => {
            const e = (e) => s.randomBytes(e).toString("hex");
...
const c = {
    ...
    toBase64WebSafe: function (t) {
        return e.Base64.encodeURI(t);
    },
    eol: "\r\n",
    validateContentType: (e) => e.length > 0 && e,
};
(exports.MIMEMessage = h),
    (exports.MIMEMessageContent = d),
    (exports.MIMEMessageHeader = r),
